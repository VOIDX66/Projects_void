...
return{
 ...
 /*function polarToRectangular(radius, angle) {//polares a rectangularess
...
function CrearFlecha(angulo, Xfin, Yfin){//se crea la cabeza del vector
  if(angulo>=0){
    var canvass=document.querySelector("#plano2 canvas");
    canvass.width=1000;
    canvass.height=1000;
 ...
 function dibujoB(t_cargas1,t_cargas2,t_cargas3,ffuerza,posicion){
  ...
  c.moveTo(x1,y1); //dibuja la linea entre cargas
    ...
    /*vector fuerza
    console.log("Coordenadas rectangulares: (", rectan.x, ",", rectan.y, ")");
    c.beginPath();
    c.moveTo(300,300);
    c.lineTo(rectan.x, rectan.y);
    c.strokeStyle = 'black';   
    c.lineWidth = 2;          
    c.stroke();
    c.closePath();*/
 ...
 if(posicion==1){
  ...
  console.log(ffuerza.fuerzar);
  console.log(ffuerza.angulo);
  /*console.log(ffuerza.grados);*/     
...
function llenar(vq1,vq2,vq3,t_cargas1,t_cargas2,t_cargas3,ffuerza,poss,posicion){
  ...
  var convertirx=(poss.x).toString() + "px";
    ...
    span_c.innerHTML="("+((vq1).toFixed(5)).toString() +"x10^-6)C";
    ...
    span_c.innerHTML="("+((vq2).toFixed(5)).toString() +"x10^-6)C";
...
cargar.addEventListener("submit",function(){
    ...
    if(cf=="c1"){
        ...
        llenar(vq1*1e-6,vq2*1e-6,vq3*1e-6,t_cargas1,t_cargas2,t_cargas3,ffuerza,poss,1);
    ...
    if(cf=="c2"){
      ...
      dibujoB(t_cargas1,t_cargas2,t_cargas3,ffuerza,2);
    ...
    if(cf=="c3"){
      ...
      dibujoB(t_cargas1,t_cargas2,t_cargas3,ffuerza,3);
